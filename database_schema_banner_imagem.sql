...
CREATE TABLE IF NOT EXISTS site_textos (
    ...
    pagina_inicial_descricao TEXT DEFAULT 'Facilitando o acesso aos produtos exclusivos.',
    footer_descricao TEXT DEFAULT 'Facilitando o acesso aos produtos exclusivos.',
